    ...
    <section id="container">
      <div class="row">
        <div class="col-md-2" id="left_sidebar">
          <img src="admin.png" class="img-rounded" width="200px" height="200px">
          ...
          <button type="button" class="btn btn-primary btn-block" id="create_notice_button">Create Notice</button>
        ...
        <div class="col-md-8" id="main_content">
          <h2>Welcome to Admin user Dashboard</h2>
        </div>
      </div>
    </section>
  </body>
